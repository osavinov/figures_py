...
def test_add_points():
    ...
    scores.update(score=1, username='test', timestamp='2020-01-07T00:00:00')
    assert scores.scores_table.get_scores() == [
        (1, 'test', '2020-01-07T00:00:00'),
    ]
...
def test_add_point_repeat():
    ...
    scores.update(score=1, username='test1', timestamp='2020-01-07T00:00:00')
    scores.update(score=2, username='test2', timestamp='2020-01-07T00:00:00')
    assert scores.scores_table.get_scores() == [
