...
class GameLevel:
    ...
    def update_field(self) -> bool:
        ...
        stop_moving: bool = False  # current_figure have to stop due to field collision
            ...
            for event in pg.event.get():
                if event.type == pg.QUIT:
                    ...
                    if event.key == pg.K_LEFT:
                        ...
                        return False
            stop_moving, points = self.field.overlay(current_figure, just_rotated)
            if points != 0:
    ...
    def draw_field(self):
        cell_x_size: int = 20
        cell_y_size: int = 20
        logger.debug("=" * (len(self.field.current_frame) + 2))
