...
class Figure:
    def __init__(
            self, template: list, target_field_width: int, figure_id: int,
    ):
        ...
        self.id = figure_id
        self.current_pos = [
            random.randint(0, target_field_width - self.x_size),
            -1,
        ]  # [x, y] starts from y=-1

    def __str__(self):
        return (
            f'(id={self.id}, x_size={self.x_size}, y_size={self.y_size}, '
