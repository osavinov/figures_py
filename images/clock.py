...
class ClockFrame:
    def __init__(self, filename):
        ...
        self.image = pygame.transform.scale(pygame.image.load(path).convert(), (200, 130))
...
class ClockFace:
    def __init__(self, digits_dir: str):
        ...
        digits_images: List[pygame.Surface] = [pygame.image.load(file).convert_alpha() for file in digits_files]
